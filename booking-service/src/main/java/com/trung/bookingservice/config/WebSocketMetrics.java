...
public class WebSocketMetrics {
    ...
    private final AtomicInteger customerConnections;
    private final AtomicInteger driverConnections;

    public WebSocketMetrics(MeterRegistry meterRegistry) {
        this.customerConnections = meterRegistry.gauge("active_users", Tags.of("role", "CUSTOMER"), new AtomicInteger(0));
        this.driverConnections = meterRegistry.gauge("active_users", Tags.of("role", "DRIVER"), new AtomicInteger(0));
    }
